...
conditions = ["ATM 1wpi", "ATM 1wpi - Food", "ATM 4wpi", "ATM 4wpi - Food", "ATM 6wpi","ATM 6wpi - Food"]
n_reps = 6
...
# bar plot
barplot!(ax_dark, enum_indices, pct_dark, color=[:dodgerblue, :dodgerblue, :dodgerblue, :dodgerblue, :dodgerblue, :dodgerblue])
