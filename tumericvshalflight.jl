...
conditions = [ "ATM 1wpi","ATM 1wpi - Tumeric","ATM 4wpi", "ATM 4wpi - Tumeric","ATM 6wpi",  "ATM 6wpi - Tumeric"]
pairs = [(1,2), (3,4), (5,6)]
n_reps = 6
...
# bar plot
barplot!(ax_dark, enum_indices, pct_dark, color=[:dodgerblue, :darkred, :dodgerblue,:darkred, :dodgerblue, :darkred])
